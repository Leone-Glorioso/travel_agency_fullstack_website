...
function ReservationsTableToLandlord({ reservations, reservationIdSearch, reservationRoomSearch, reservationClientSearch,  handleInputChange,
...
export default ReservationsTableToLandlord