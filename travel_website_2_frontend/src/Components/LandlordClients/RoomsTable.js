...
function RoomsTableLandlordClient({ rooms, roomIdSearch, handleInputChange, handleDeleteRoom, handleSearchRoomId, handleGetRooms }) {
    let roomList
    if (rooms.length === 0) {
        roomList = (
...
export default RoomsTableLandlordClient