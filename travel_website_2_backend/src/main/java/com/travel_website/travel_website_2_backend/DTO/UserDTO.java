...
public record UserDTO(int id, String name, String surname, String email, long telephone, String country, UserCategories role, String username, String password) {
    public record ReservationDto(int id, LocalDate start, LocalDate end)
    {

    }

    public record PhotoDto(int id)
    {
